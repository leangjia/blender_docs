#!/bin/bash
# This script geneates one po file for each language for use on Weblate.
# This script is based on https://github.com/godotengine/godot-docs-l10n/blob/master/update.sh
...
# Defines
SOURCE_DIR="../manual"
SPHINX_TEMPLATES_DIR="../locale/sphinx/templates"
